...
-- Drop and recreate dim_customer
...
CREATE OR ALTER VIEW gold.dim_customers AS
	SELECT 
		...
		CASE 
			WHEN cst_gnder != 'n/a' THEN ci.cst_gnder -- CRM is the master of gender info
...
CREATE OR ALTER VIEW gold.dim_products AS
	...
	LEFT JOIN silver.erp_px_cat_g1v2 px ON px.id = pin.prd_cat_id
...
CREATE OR ALTER VIEW gold.fact_sales AS
	...
	LEFT JOIN gold.dim_products p ON p.product_number = sd.sls_prd_key;
GO
